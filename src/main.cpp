...
static const std::unordered_map<std::string_view, LogoProperties> g_artists = {
    ...
    { "availax", LogoProperties{ .offsetY = -1.4f, .extraHeight = -2.f } },
    { "dirtypawsofficial", LogoProperties{ .offsetY = -1.4f, .extraHeight = 0.f } },
    ...
    { "LLAAPPSSEE", LogoProperties{ .offsetY = -2.38f, .extraHeight = 8.5f } },
};
